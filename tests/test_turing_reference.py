...
import pytest
from src.turing_machine.turing import Hooks, Turing
from src.turing_machine.turing_provenance import ProvenanceGraph, instrument_hooks
from typing import List, Tuple
from src.turing_machine import docstrings_math
