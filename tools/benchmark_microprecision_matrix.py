...
class _FortranCoreNative:
    ...
    def __init__(self, library_path: Path, entry_record):
        ...
        function = getattr(ctypes.CDLL(str(library_path)), symbol)
    ...
    def prepare_execution(self, feeds) -> _FortranCoreExecution:
        import ctypes
        import re
