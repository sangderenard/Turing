...
entry:
  ...
  %pinned.load.1.14 = load double, ptr %address.0.29, align 8
  store double %pinned.load.1.14, ptr %out.0, align 8
  %load.2.15.0 = load double, ptr %out.0, align 8
  %scalar.2.15 = fmul double %load.2.15.0, %load.2.15.0
  store double %scalar.2.15, ptr %out.1, align 8
  ret void
}
...
define void @__ssa_sinh_core_pack__sinh_core_pack(ptr noalias %arg.0, ptr noalias %arg.1, ptr %arg.2, ptr noalias %arg.3, ptr noalias %arg.4, ptr noalias %arg.5, ptr noalias %arg.6, ptr noalias %arg.7, ptr noalias %arg.8, ptr noalias %arg.9, ptr noalias %arg.10, ptr noalias %arg.11, ptr %out.0) {
entry:
...
loop_body:
  ...
  call void @__ssa_sinh_core_pack__sinh_core(ptr %arg.3, ptr %arg.4, ptr %arg.5, ptr %arg.6, ptr %arg.7, ptr %arg.8, ptr %arg.9, ptr %arg.10, ptr %arg.11, ptr %value.15, ptr %value.14, ptr %value.16)
...
entry:
  ...
  %load.16.27.0 = load double, ptr %arg.10, align 8
  %scalar.16.27 = fmul double %load.16.27.0, %scalar.15.26
  store double %scalar.16.27, ptr %out.0, align 8
  ret void
}

define void @__ssa_sinh_core_pack__sinh_core(ptr noalias %arg.0, ptr noalias %arg.1, ptr noalias %arg.2, ptr noalias %arg.3, ptr noalias %arg.4, ptr noalias %arg.5, ptr noalias %arg.6, ptr noalias %arg.7, ptr noalias %arg.8, ptr %arg.9, ptr %arg.10, ptr %out.0) {
entry:
  ...
  call void @__ssa_sinh_core_pack__sinh_core__planned_region_0(ptr %arg.8, ptr %arg.9, ptr %arg.7, ptr %arg.6, ptr %arg.5, ptr %arg.4, ptr %arg.3, ptr %arg.2, ptr %arg.1, ptr %arg.0, ptr %arg.10, ptr %out.0, ptr %value.11, ptr %value.12, ptr %value.13, ptr %value.14, ptr %value.15, ptr %value.16, ptr %value.17, ptr %value.18, ptr %value.19, ptr %value.20, ptr %value.21, ptr %value.22, ptr %value.23, ptr %value.24, ptr %value.25, ptr %value.26)
  ret void
}
...
entry:
  ...
  call void @__ssa_sinh_core_pack__sinh_core_pack(ptr %public.0, ptr %public.1, ptr %public.2, ptr %public.3, ptr %public.4, ptr %public.5, ptr %public.6, ptr %public.7, ptr %public.8, ptr %public.9, ptr %public.10, ptr %public.11, ptr %public.2)
  ret void
}
