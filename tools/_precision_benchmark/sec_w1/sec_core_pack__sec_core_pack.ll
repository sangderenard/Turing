...
loop_body:
  ...
  call void @__ssa_sec_core_pack__sec_core(ptr %arg.3, ptr %arg.4, ptr %arg.5, ptr %arg.6, ptr %arg.7, ptr %arg.8, ptr %arg.9, ptr %arg.10, ptr %arg.11, ptr %arg.12, ptr %arg.13, ptr %arg.14, ptr %arg.15, ptr %arg.16, ptr %arg.17, ptr %arg.18, ptr %arg.19, ptr %arg.20, ptr %value.24, ptr %value.25)
...
define void @__ssa_sec_core_pack__sec_core__planned_region_0(ptr noalias %arg.0, ptr %arg.1, ptr noalias %arg.2, ptr noalias %arg.3, ptr noalias %arg.4, ptr noalias %arg.5, ptr noalias %arg.6, ptr noalias %arg.7, ptr noalias %arg.8, ptr noalias %arg.9, ptr noalias %arg.10, ptr noalias %arg.11, ptr noalias %arg.12, ptr noalias %arg.13, ptr noalias %arg.14, ptr noalias %arg.15, ptr noalias %arg.16, ptr noalias %arg.17, ptr noalias %arg.18, ptr %out.0, ptr %out.1, ptr %out.2, ptr %out.3, ptr %out.4, ptr %out.5, ptr %out.6, ptr %out.7, ptr %out.8, ptr %out.9, ptr %out.10, ptr %out.11, ptr %out.12, ptr %out.13, ptr %out.14, ptr %out.15, ptr %out.16, ptr %out.17, ptr %out.18, ptr %out.19, ptr %out.20, ptr %out.21, ptr %out.22, ptr %out.23, ptr %out.24, ptr %out.25, ptr %out.26, ptr %out.27, ptr %out.28, ptr %out.29, ptr %out.30, ptr %out.31, ptr %out.32, ptr %out.33) {
entry:
  %load.0.19.0 = load double, ptr %arg.0, align 8
  %load.0.19.1 = load double, ptr %arg.1, align 8
  %scalar.0.19 = fmul double %load.0.19.0, %load.0.19.1
  store double %scalar.0.19, ptr %out.1, align 8
  %load.1.20.0 = load double, ptr %arg.2, align 8
  %scalar.1.20 = fadd double %load.1.20.0, %scalar.0.19
  store double %scalar.1.20, ptr %out.2, align 8
  %scalar.2.21 = fmul double %load.0.19.1, %scalar.1.20
  store double %scalar.2.21, ptr %out.3, align 8
  %load.3.22.0 = load double, ptr %arg.3, align 8
  %scalar.3.22 = fadd double %load.3.22.0, %scalar.2.21
  store double %scalar.3.22, ptr %out.4, align 8
  %scalar.4.23 = fmul double %load.0.19.1, %scalar.3.22
  store double %scalar.4.23, ptr %out.5, align 8
  %load.5.24.0 = load double, ptr %arg.4, align 8
  %scalar.5.24 = fadd double %load.5.24.0, %scalar.4.23
  store double %scalar.5.24, ptr %out.6, align 8
  %scalar.6.25 = fmul double %load.0.19.1, %scalar.5.24
  store double %scalar.6.25, ptr %out.7, align 8
  %load.7.26.0 = load double, ptr %arg.5, align 8
  %scalar.7.26 = fadd double %load.7.26.0, %scalar.6.25
  store double %scalar.7.26, ptr %out.8, align 8
  %scalar.8.27 = fmul double %load.0.19.1, %scalar.7.26
  store double %scalar.8.27, ptr %out.9, align 8
  %load.9.28.0 = load double, ptr %arg.6, align 8
  %scalar.9.28 = fadd double %load.9.28.0, %scalar.8.27
  store double %scalar.9.28, ptr %out.10, align 8
  %scalar.10.29 = fmul double %load.0.19.1, %scalar.9.28
  store double %scalar.10.29, ptr %out.11, align 8
  %load.11.30.0 = load double, ptr %arg.7, align 8
  %scalar.11.30 = fadd double %load.11.30.0, %scalar.10.29
  store double %scalar.11.30, ptr %out.12, align 8
  %scalar.12.31 = fmul double %load.0.19.1, %scalar.11.30
  store double %scalar.12.31, ptr %out.13, align 8
  %load.13.32.0 = load double, ptr %arg.8, align 8
  %scalar.13.32 = fadd double %load.13.32.0, %scalar.12.31
  store double %scalar.13.32, ptr %out.14, align 8
  %scalar.14.33 = fmul double %load.0.19.1, %scalar.13.32
  store double %scalar.14.33, ptr %out.15, align 8
  %load.15.34.0 = load double, ptr %arg.9, align 8
  %scalar.15.34 = fadd double %load.15.34.0, %scalar.14.33
  store double %scalar.15.34, ptr %out.16, align 8
  %scalar.16.35 = fmul double %load.0.19.1, %scalar.15.34
  store double %scalar.16.35, ptr %out.17, align 8
  %load.17.36.0 = load double, ptr %arg.10, align 8
  %scalar.17.36 = fadd double %load.17.36.0, %scalar.16.35
  store double %scalar.17.36, ptr %out.18, align 8
  %scalar.18.37 = fmul double %load.0.19.1, %scalar.17.36
  store double %scalar.18.37, ptr %out.19, align 8
  %load.19.38.0 = load double, ptr %arg.11, align 8
  %scalar.19.38 = fadd double %load.19.38.0, %scalar.18.37
  store double %scalar.19.38, ptr %out.20, align 8
  %scalar.20.39 = fmul double %load.0.19.1, %scalar.19.38
  store double %scalar.20.39, ptr %out.21, align 8
  %load.21.40.0 = load double, ptr %arg.12, align 8
  %scalar.21.40 = fadd double %load.21.40.0, %scalar.20.39
  store double %scalar.21.40, ptr %out.22, align 8
  %scalar.22.41 = fmul double %load.0.19.1, %scalar.21.40
  store double %scalar.22.41, ptr %out.23, align 8
  %load.23.42.0 = load double, ptr %arg.13, align 8
  %scalar.23.42 = fadd double %load.23.42.0, %scalar.22.41
  store double %scalar.23.42, ptr %out.24, align 8
  %scalar.24.43 = fmul double %load.0.19.1, %scalar.23.42
  store double %scalar.24.43, ptr %out.25, align 8
  %load.25.44.0 = load double, ptr %arg.14, align 8
  %scalar.25.44 = fadd double %load.25.44.0, %scalar.24.43
  store double %scalar.25.44, ptr %out.26, align 8
  %scalar.26.45 = fmul double %load.0.19.1, %scalar.25.44
  store double %scalar.26.45, ptr %out.27, align 8
  %load.27.46.0 = load double, ptr %arg.15, align 8
  %scalar.27.46 = fadd double %load.27.46.0, %scalar.26.45
  store double %scalar.27.46, ptr %out.28, align 8
  %scalar.28.47 = fmul double %load.0.19.1, %scalar.27.46
  store double %scalar.28.47, ptr %out.29, align 8
  %load.29.48.0 = load double, ptr %arg.16, align 8
  %scalar.29.48 = fadd double %load.29.48.0, %scalar.28.47
  store double %scalar.29.48, ptr %out.30, align 8
  %scalar.30.49 = fmul double %load.0.19.1, %scalar.29.48
  store double %scalar.30.49, ptr %out.31, align 8
  %load.31.50.0 = load double, ptr %arg.17, align 8
  %scalar.31.50 = fadd double %load.31.50.0, %scalar.30.49
  store double %scalar.31.50, ptr %out.32, align 8
  %scalar.32.51 = fmul double %load.0.19.1, %scalar.31.50
  store double %scalar.32.51, ptr %out.33, align 8
  %load.33.52.0 = load double, ptr %arg.18, align 8
  %scalar.33.52 = fadd double %load.33.52.0, %scalar.32.51
  store double %scalar.33.52, ptr %out.0, align 8
  ret void
}

define void @__ssa_sec_core_pack__sec_core(ptr noalias %arg.0, ptr noalias %arg.1, ptr noalias %arg.2, ptr noalias %arg.3, ptr noalias %arg.4, ptr noalias %arg.5, ptr noalias %arg.6, ptr noalias %arg.7, ptr noalias %arg.8, ptr noalias %arg.9, ptr noalias %arg.10, ptr noalias %arg.11, ptr noalias %arg.12, ptr noalias %arg.13, ptr noalias %arg.14, ptr noalias %arg.15, ptr noalias %arg.16, ptr noalias %arg.17, ptr %arg.18, ptr %out.0) {
entry:
