source_filename = "turing.ssa-llvm.log1p_core_pack__log1p_core_pack"
...
define void @__ssa_log1p_core_pack__log1p_core_pack__planned_region_0(ptr noalias %arg.0, ptr %arg.1, ptr %out.0) {
entry:
  %load.0.44.0 = load i32, ptr %arg.1, align 4
  %address.0.44 = getelementptr double, ptr %arg.0, i32 %load.0.44.0
  %pinned.load.1.32 = load double, ptr %address.0.44, align 8
  store double %pinned.load.1.32, ptr %out.0, align 8
  ret void
}

define void @__ssa_log1p_core_pack__log1p_core_pack__planned_region_1(ptr %arg.0, ptr %arg.1, ptr %arg.2) {
entry:
  ...
  store double %load.store.1.v, ptr %address.0.45, align 8
  ret void
}

define void @__ssa_log1p_core_pack__log1p_core_pack(ptr noalias %arg.0, ptr noalias %arg.1, ptr %arg.2, ptr noalias %arg.3, ptr noalias %arg.4, ptr noalias %arg.5, ptr noalias %arg.6, ptr noalias %arg.7, ptr noalias %arg.8, ptr noalias %arg.9, ptr noalias %arg.10, ptr noalias %arg.11, ptr noalias %arg.12, ptr noalias %arg.13, ptr noalias %arg.14, ptr noalias %arg.15, ptr noalias %arg.16, ptr noalias %arg.17, ptr noalias %arg.18, ptr noalias %arg.19, ptr noalias %arg.20, ptr noalias %arg.21, ptr noalias %arg.22, ptr noalias %arg.23, ptr noalias %arg.24, ptr noalias %arg.25, ptr noalias %arg.26, ptr noalias %arg.27, ptr noalias %arg.28, ptr noalias %arg.29, ptr noalias %arg.30, ptr noalias %arg.31, ptr noalias %arg.32, ptr noalias %arg.33, ptr noalias %arg.34, ptr noalias %arg.35, ptr noalias %arg.36, ptr noalias %arg.37, ptr noalias %arg.38, ptr noalias %arg.39, ptr noalias %arg.40, ptr noalias %arg.41, ptr noalias %arg.42, ptr noalias %arg.43, ptr noalias %arg.44, ptr noalias %arg.45, ptr noalias %arg.46, ptr noalias %arg.47, ptr noalias %arg.48, ptr noalias %arg.49, ptr noalias %arg.50, ptr noalias %arg.51, ptr noalias %arg.52, ptr noalias %arg.53, ptr noalias %arg.54, ptr noalias %arg.55, ptr noalias %arg.56, ptr %out.0) {
entry:
...
loop_header:
  ...
  %load.5.40.0 = load i32, ptr %phi.38, align 4
  %load.5.40.1 = load i32, ptr %arg.0, align 4
  %scalar.5.40 = icmp slt i32 %load.5.40.0, %load.5.40.1
  store i1 %scalar.5.40, ptr %value.40, align 1
  br i1 %scalar.5.40, label %loop_body, label %loop_exit
loop_body:
  call void @__ssa_log1p_core_pack__log1p_core_pack__planned_region_0(ptr %arg.1, ptr %phi.38, ptr %value.32)
  call void @__ssa_log1p_core_pack__log1p_core(ptr %arg.3, ptr %arg.4, ptr %arg.5, ptr %arg.6, ptr %arg.7, ptr %arg.8, ptr %arg.9, ptr %arg.10, ptr %arg.11, ptr %arg.12, ptr %arg.13, ptr %arg.14, ptr %arg.15, ptr %arg.16, ptr %arg.17, ptr %arg.18, ptr %arg.19, ptr %arg.20, ptr %arg.21, ptr %arg.22, ptr %arg.23, ptr %arg.24, ptr %arg.25, ptr %arg.26, ptr %arg.27, ptr %arg.28, ptr %arg.29, ptr %value.32, ptr %value.32, ptr %arg.30, ptr %arg.31, ptr %arg.32, ptr %arg.33, ptr %arg.34, ptr %arg.35, ptr %arg.36, ptr %arg.37, ptr %arg.38, ptr %arg.39, ptr %arg.40, ptr %arg.41, ptr %arg.42, ptr %arg.43, ptr %arg.44, ptr %arg.45, ptr %arg.46, ptr %arg.47, ptr %arg.48, ptr %arg.49, ptr %arg.50, ptr %arg.51, ptr %arg.52, ptr %arg.53, ptr %arg.54, ptr %arg.55, ptr %arg.56, ptr %value.32, ptr %value.32, ptr %value.33)
  call void @__ssa_log1p_core_pack__log1p_core_pack__planned_region_1(ptr %arg.2, ptr %phi.38, ptr %value.33)
  br label %loop_latch
loop_latch:
  %load.13.39.0 = load i32, ptr %phi.38, align 4
  %load.13.39.1 = load i64, ptr %value.37, align 8
  %convert.13.39.1 = trunc i64 %load.13.39.1 to i32
  %scalar.13.39 = add i32 %load.13.39.0, %convert.13.39.1
  %declared.13.39 = sext i32 %scalar.13.39 to i64
  store i64 %declared.13.39, ptr %value.39, align 8
  br label %loop_header
loop_exit:
...
define void @__ssa_log1p_core_pack__log1p_core__planned_region_0(ptr noalias %arg.0, ptr %arg.1, ptr noalias %arg.2, ptr noalias %arg.3, ptr noalias %arg.4, ptr noalias %arg.5, ptr noalias %arg.6, ptr noalias %arg.7, ptr noalias %arg.8, ptr noalias %arg.9, ptr noalias %arg.10, ptr noalias %arg.11, ptr noalias %arg.12, ptr noalias %arg.13, ptr noalias %arg.14, ptr noalias %arg.15, ptr noalias %arg.16, ptr noalias %arg.17, ptr noalias %arg.18, ptr noalias %arg.19, ptr noalias %arg.20, ptr noalias %arg.21, ptr noalias %arg.22, ptr noalias %arg.23, ptr noalias %arg.24, ptr noalias %arg.25, ptr noalias %arg.26, ptr noalias %arg.27, ptr %arg.28, ptr noalias %arg.29, ptr %arg.30, ptr noalias %arg.31, ptr noalias %arg.32, ptr noalias %arg.33, ptr noalias %arg.34, ptr noalias %arg.35, ptr noalias %arg.36, ptr noalias %arg.37, ptr noalias %arg.38, ptr noalias %arg.39, ptr noalias %arg.40, ptr noalias %arg.41, ptr noalias %arg.42, ptr noalias %arg.43, ptr noalias %arg.44, ptr noalias %arg.45, ptr noalias %arg.46, ptr noalias %arg.47, ptr noalias %arg.48, ptr noalias %arg.49, ptr noalias %arg.50, ptr noalias %arg.51, ptr noalias %arg.52, ptr noalias %arg.53, ptr noalias %arg.54, ptr noalias %arg.55, ptr noalias %arg.56, ptr %arg.57, ptr %out.0, ptr %out.1, ptr %out.2, ptr %out.3, ptr %out.4, ptr %out.5, ptr %out.6, ptr %out.7, ptr %out.8, ptr %out.9, ptr %out.10, ptr %out.11, ptr %out.12, ptr %out.13, ptr %out.14, ptr %out.15, ptr %out.16, ptr %out.17, ptr %out.18, ptr %out.19, ptr %out.20, ptr %out.21, ptr %out.22, ptr %out.23, ptr %out.24, ptr %out.25, ptr %out.26, ptr %out.27, ptr %out.28, ptr %out.29, ptr %out.30, ptr %out.31, ptr %out.32, ptr %out.33, ptr %out.34, ptr %out.35, ptr %out.36, ptr %out.37, ptr %out.38, ptr %out.39, ptr %out.40, ptr %out.41, ptr %out.42, ptr %out.43, ptr %out.44, ptr %out.45, ptr %out.46, ptr %out.47, ptr %out.48, ptr %out.49, ptr %out.50, ptr %out.51, ptr %out.52) {
entry:
  ...
  %load.3.277.1 = load double, ptr %arg.30, align 8
  ...
  %load.5.279.0 = load double, ptr %arg.29, align 8
  ...
  %scalar.10.29 = fadd double %scalar.7.281, %scalar.9.283
  store double %scalar.10.29, ptr %out.1, align 8
  ...
  %load.17.290.1 = load double, ptr %arg.31, align 8
  ...
  %scalar.22.30 = fadd double %scalar.19.292, %scalar.21.294
  store double %scalar.22.30, ptr %out.2, align 8
  ...
  %scalar.33.31 = fadd double %scalar.30.302, %scalar.32.304
  store double %scalar.33.31, ptr %out.3, align 8
  ...
  %load.40.311.1 = load double, ptr %arg.32, align 8
  ...
  %scalar.45.32 = fadd double %scalar.42.313, %scalar.44.315
  store double %scalar.45.32, ptr %out.4, align 8
  ...
  %scalar.56.33 = fadd double %scalar.53.323, %scalar.55.325
  store double %scalar.56.33, ptr %out.5, align 8
  ...
  %load.63.332.1 = load double, ptr %arg.33, align 8
  ...
  %scalar.68.34 = fadd double %scalar.65.334, %scalar.67.336
  store double %scalar.68.34, ptr %out.6, align 8
  ...
  %scalar.79.35 = fadd double %scalar.76.344, %scalar.78.346
  store double %scalar.79.35, ptr %out.7, align 8
  ...
  %load.86.353.1 = load double, ptr %arg.34, align 8
  ...
  %scalar.91.36 = fadd double %scalar.88.355, %scalar.90.357
  store double %scalar.91.36, ptr %out.8, align 8
  ...
  %scalar.102.37 = fadd double %scalar.99.365, %scalar.101.367
  store double %scalar.102.37, ptr %out.9, align 8
  ...
  %load.109.374.1 = load double, ptr %arg.35, align 8
  ...
  %scalar.114.38 = fadd double %scalar.111.376, %scalar.113.378
  store double %scalar.114.38, ptr %out.10, align 8
  ...
  %scalar.125.39 = fadd double %scalar.122.386, %scalar.124.388
  store double %scalar.125.39, ptr %out.11, align 8
  ...
  %load.132.395.1 = load double, ptr %arg.36, align 8
  ...
  %scalar.137.40 = fadd double %scalar.134.397, %scalar.136.399
  store double %scalar.137.40, ptr %out.12, align 8
  ...
  %scalar.148.41 = fadd double %scalar.145.407, %scalar.147.409
  store double %scalar.148.41, ptr %out.13, align 8
  ...
  %load.155.416.1 = load double, ptr %arg.37, align 8
  ...
  %scalar.160.42 = fadd double %scalar.157.418, %scalar.159.420
  store double %scalar.160.42, ptr %out.14, align 8
  ...
  %scalar.171.43 = fadd double %scalar.168.428, %scalar.170.430
  store double %scalar.171.43, ptr %out.15, align 8
  ...
  %load.178.437.1 = load double, ptr %arg.38, align 8
  ...
  %scalar.183.44 = fadd double %scalar.180.439, %scalar.182.441
  store double %scalar.183.44, ptr %out.16, align 8
  ...
  %scalar.194.45 = fadd double %scalar.191.449, %scalar.193.451
  store double %scalar.194.45, ptr %out.17, align 8
  ...
  %load.201.458.1 = load double, ptr %arg.39, align 8
  ...
  %scalar.206.46 = fadd double %scalar.203.460, %scalar.205.462
  store double %scalar.206.46, ptr %out.18, align 8
  ...
  %scalar.217.47 = fadd double %scalar.214.470, %scalar.216.472
  store double %scalar.217.47, ptr %out.19, align 8
  ...
  %load.224.479.1 = load double, ptr %arg.40, align 8
  ...
  %scalar.229.48 = fadd double %scalar.226.481, %scalar.228.483
  store double %scalar.229.48, ptr %out.20, align 8
  ...
  %scalar.240.49 = fadd double %scalar.237.491, %scalar.239.493
  store double %scalar.240.49, ptr %out.21, align 8
  ...
  %load.247.500.1 = load double, ptr %arg.41, align 8
  ...
  %scalar.252.50 = fadd double %scalar.249.502, %scalar.251.504
  store double %scalar.252.50, ptr %out.22, align 8
  ...
  %scalar.263.51 = fadd double %scalar.260.512, %scalar.262.514
  store double %scalar.263.51, ptr %out.23, align 8
  ...
  %load.270.521.1 = load double, ptr %arg.42, align 8
  ...
  %scalar.275.52 = fadd double %scalar.272.523, %scalar.274.525
  store double %scalar.275.52, ptr %out.24, align 8
  ...
  %scalar.286.53 = fadd double %scalar.283.533, %scalar.285.535
  store double %scalar.286.53, ptr %out.25, align 8
  ...
  %load.293.542.1 = load double, ptr %arg.43, align 8
  ...
  %scalar.298.54 = fadd double %scalar.295.544, %scalar.297.546
  store double %scalar.298.54, ptr %out.26, align 8
  ...
  %scalar.309.55 = fadd double %scalar.306.554, %scalar.308.556
  store double %scalar.309.55, ptr %out.27, align 8
  ...
  %load.316.563.1 = load double, ptr %arg.44, align 8
  ...
  %scalar.321.56 = fadd double %scalar.318.565, %scalar.320.567
  store double %scalar.321.56, ptr %out.28, align 8
  ...
  %scalar.332.57 = fadd double %scalar.329.575, %scalar.331.577
  store double %scalar.332.57, ptr %out.29, align 8
  ...
  %load.339.584.1 = load double, ptr %arg.45, align 8
  ...
  %scalar.344.58 = fadd double %scalar.341.586, %scalar.343.588
  store double %scalar.344.58, ptr %out.30, align 8
  ...
  %scalar.355.59 = fadd double %scalar.352.596, %scalar.354.598
  store double %scalar.355.59, ptr %out.31, align 8
  ...
  %load.362.605.1 = load double, ptr %arg.46, align 8
  ...
  %scalar.367.60 = fadd double %scalar.364.607, %scalar.366.609
  store double %scalar.367.60, ptr %out.32, align 8
  ...
  %scalar.378.61 = fadd double %scalar.375.617, %scalar.377.619
  store double %scalar.378.61, ptr %out.33, align 8
  ...
  %load.385.626.1 = load double, ptr %arg.47, align 8
  ...
  %scalar.390.62 = fadd double %scalar.387.628, %scalar.389.630
  store double %scalar.390.62, ptr %out.34, align 8
  ...
  %scalar.401.63 = fadd double %scalar.398.638, %scalar.400.640
  store double %scalar.401.63, ptr %out.35, align 8
  ...
  %load.408.647.1 = load double, ptr %arg.48, align 8
  ...
  %scalar.413.64 = fadd double %scalar.410.649, %scalar.412.651
  store double %scalar.413.64, ptr %out.36, align 8
  ...
  %scalar.424.65 = fadd double %scalar.421.659, %scalar.423.661
  store double %scalar.424.65, ptr %out.37, align 8
  ...
  %load.431.668.1 = load double, ptr %arg.49, align 8
  ...
  %scalar.436.66 = fadd double %scalar.433.670, %scalar.435.672
  store double %scalar.436.66, ptr %out.38, align 8
  ...
  %scalar.447.67 = fadd double %scalar.444.680, %scalar.446.682
  store double %scalar.447.67, ptr %out.39, align 8
  ...
  %load.454.689.1 = load double, ptr %arg.50, align 8
  ...
  %scalar.459.68 = fadd double %scalar.456.691, %scalar.458.693
  store double %scalar.459.68, ptr %out.40, align 8
  ...
  %scalar.470.69 = fadd double %scalar.467.701, %scalar.469.703
  store double %scalar.470.69, ptr %out.41, align 8
  ...
  %load.477.710.1 = load double, ptr %arg.51, align 8
  ...
  %scalar.482.70 = fadd double %scalar.479.712, %scalar.481.714
  store double %scalar.482.70, ptr %out.42, align 8
  ...
  %scalar.493.71 = fadd double %scalar.490.722, %scalar.492.724
  store double %scalar.493.71, ptr %out.43, align 8
  ...
  %load.500.731.1 = load double, ptr %arg.52, align 8
  ...
  %scalar.505.72 = fadd double %scalar.502.733, %scalar.504.735
  store double %scalar.505.72, ptr %out.44, align 8
  ...
  %scalar.516.73 = fadd double %scalar.513.743, %scalar.515.745
  store double %scalar.516.73, ptr %out.45, align 8
  ...
  %load.523.752.1 = load double, ptr %arg.53, align 8
  ...
  %scalar.528.74 = fadd double %scalar.525.754, %scalar.527.756
  store double %scalar.528.74, ptr %out.46, align 8
  ...
  %scalar.539.75 = fadd double %scalar.536.764, %scalar.538.766
  store double %scalar.539.75, ptr %out.47, align 8
  ...
  %load.546.773.1 = load double, ptr %arg.54, align 8
  ...
  %scalar.551.76 = fadd double %scalar.548.775, %scalar.550.777
  store double %scalar.551.76, ptr %out.48, align 8
  %scalar.552.778 = fmul double %load.0.274.1, %scalar.548.775
  ...
  %scalar.554.780 = call double @llvm.fma.f64(double %load.0.274.1, double %scalar.548.775, double %scalar.553.779)
  store double %scalar.554.780, ptr %value.780, align 8
  %scalar.555.781 = fmul double %load.0.274.1, %scalar.550.777
  ...
  %scalar.557.783 = fmul double %load.3.277.1, %scalar.548.775
  ...
  %scalar.562.77 = fadd double %scalar.559.785, %scalar.561.787
  store double %scalar.562.77, ptr %out.49, align 8
  %load.563.788.0 = load double, ptr %arg.26, align 8
  %scalar.563.788 = fadd double %load.563.788.0, %scalar.559.785
  store double %scalar.563.788, ptr %value.788, align 8
  %scalar.564.789 = fsub double %scalar.563.788, %load.563.788.0
  store double %scalar.564.789, ptr %value.789, align 8
  %scalar.565.790 = fsub double %scalar.563.788, %scalar.564.789
  store double %scalar.565.790, ptr %value.790, align 8
  %scalar.566.791 = fsub double %load.563.788.0, %scalar.565.790
  store double %scalar.566.791, ptr %value.791, align 8
  %scalar.567.792 = fsub double %scalar.559.785, %scalar.564.789
  store double %scalar.567.792, ptr %value.792, align 8
  %scalar.568.793 = fadd double %scalar.566.791, %scalar.567.792
  store double %scalar.568.793, ptr %value.793, align 8
  %load.569.794.1 = load double, ptr %arg.55, align 8
  %scalar.569.794 = fadd double %scalar.568.793, %load.569.794.1
  store double %scalar.569.794, ptr %value.794, align 8
  %scalar.570.795 = fadd double %scalar.569.794, %scalar.561.787
  store double %scalar.570.795, ptr %value.795, align 8
  %scalar.571.796 = fadd double %scalar.563.788, %scalar.570.795
  store double %scalar.571.796, ptr %value.796, align 8
  %scalar.572.797 = fsub double %scalar.571.796, %scalar.563.788
  store double %scalar.572.797, ptr %value.797, align 8
  %scalar.573.798 = fsub double %scalar.570.795, %scalar.572.797
  store double %scalar.573.798, ptr %value.798, align 8
  %scalar.574.78 = fadd double %scalar.571.796, %scalar.573.798
  store double %scalar.574.78, ptr %out.50, align 8
  %scalar.575.799 = fmul double %load.0.274.1, %scalar.571.796
  store double %scalar.575.799, ptr %value.799, align 8
  %scalar.576.800 = fneg double %scalar.575.799
  store double %scalar.576.800, ptr %value.800, align 8
  %scalar.577.801 = call double @llvm.fma.f64(double %load.0.274.1, double %scalar.571.796, double %scalar.576.800)
  store double %scalar.577.801, ptr %value.801, align 8
  %scalar.578.802 = fmul double %load.0.274.1, %scalar.573.798
  store double %scalar.578.802, ptr %value.802, align 8
  %scalar.579.803 = fadd double %scalar.577.801, %scalar.578.802
  store double %scalar.579.803, ptr %value.803, align 8
  %scalar.580.804 = fmul double %load.3.277.1, %scalar.571.796
  store double %scalar.580.804, ptr %value.804, align 8
  %scalar.581.805 = fadd double %scalar.579.803, %scalar.580.804
  store double %scalar.581.805, ptr %value.805, align 8
  %scalar.582.806 = fadd double %scalar.575.799, %scalar.581.805
  store double %scalar.582.806, ptr %value.806, align 8
  %scalar.583.807 = fsub double %scalar.582.806, %scalar.575.799
  store double %scalar.583.807, ptr %value.807, align 8
  %scalar.584.808 = fsub double %scalar.581.805, %scalar.583.807
  store double %scalar.584.808, ptr %value.808, align 8
  %scalar.585.79 = fadd double %scalar.582.806, %scalar.584.808
  store double %scalar.585.79, ptr %out.51, align 8
  %load.586.809.0 = load double, ptr %arg.27, align 8
  %scalar.586.809 = fadd double %load.586.809.0, %scalar.582.806
  store double %scalar.586.809, ptr %value.809, align 8
  %scalar.587.810 = fsub double %scalar.586.809, %load.586.809.0
  store double %scalar.587.810, ptr %value.810, align 8
  %scalar.588.811 = fsub double %scalar.586.809, %scalar.587.810
  store double %scalar.588.811, ptr %value.811, align 8
  %scalar.589.812 = fsub double %load.586.809.0, %scalar.588.811
  store double %scalar.589.812, ptr %value.812, align 8
  %scalar.590.813 = fsub double %scalar.582.806, %scalar.587.810
  store double %scalar.590.813, ptr %value.813, align 8
  %scalar.591.814 = fadd double %scalar.589.812, %scalar.590.813
  store double %scalar.591.814, ptr %value.814, align 8
  %load.592.815.1 = load double, ptr %arg.56, align 8
  %scalar.592.815 = fadd double %scalar.591.814, %load.592.815.1
  store double %scalar.592.815, ptr %value.815, align 8
  %scalar.593.816 = fadd double %scalar.592.815, %scalar.584.808
  store double %scalar.593.816, ptr %value.816, align 8
  %scalar.594.817 = fadd double %scalar.586.809, %scalar.593.816
  store double %scalar.594.817, ptr %value.817, align 8
  %scalar.595.818 = fsub double %scalar.594.817, %scalar.586.809
  store double %scalar.595.818, ptr %value.818, align 8
  %scalar.596.819 = fsub double %scalar.593.816, %scalar.595.818
  store double %scalar.596.819, ptr %value.819, align 8
  %scalar.597.80 = fadd double %scalar.594.817, %scalar.596.819
  store double %scalar.597.80, ptr %out.52, align 8
  %load.598.820.0 = load double, ptr %arg.28, align 8
  %scalar.598.820 = fmul double %load.598.820.0, %scalar.594.817
  store double %scalar.598.820, ptr %value.820, align 8
  %scalar.599.821 = fneg double %scalar.598.820
  store double %scalar.599.821, ptr %value.821, align 8
  %scalar.600.822 = call double @llvm.fma.f64(double %load.598.820.0, double %scalar.594.817, double %scalar.599.821)
  store double %scalar.600.822, ptr %value.822, align 8
  %scalar.601.823 = fmul double %load.598.820.0, %scalar.596.819
  store double %scalar.601.823, ptr %value.823, align 8
  %scalar.602.824 = fadd double %scalar.600.822, %scalar.601.823
  store double %scalar.602.824, ptr %value.824, align 8
  %load.603.825.0 = load double, ptr %arg.57, align 8
  %scalar.603.825 = fmul double %load.603.825.0, %scalar.594.817
  store double %scalar.603.825, ptr %value.825, align 8
  %scalar.604.826 = fadd double %scalar.602.824, %scalar.603.825
  store double %scalar.604.826, ptr %value.826, align 8
  %scalar.605.827 = fadd double %scalar.598.820, %scalar.604.826
  store double %scalar.605.827, ptr %value.827, align 8
  %scalar.606.828 = fsub double %scalar.605.827, %scalar.598.820
  store double %scalar.606.828, ptr %value.828, align 8
  %scalar.607.829 = fsub double %scalar.604.826, %scalar.606.828
  store double %scalar.607.829, ptr %value.829, align 8
  %scalar.608.81 = fadd double %scalar.605.827, %scalar.607.829
  store double %scalar.608.81, ptr %out.0, align 8
  ret void
}

define void @__ssa_log1p_core_pack__log1p_core(ptr noalias %arg.0, ptr noalias %arg.1, ptr noalias %arg.2, ptr noalias %arg.3, ptr noalias %arg.4, ptr noalias %arg.5, ptr noalias %arg.6, ptr noalias %arg.7, ptr noalias %arg.8, ptr noalias %arg.9, ptr noalias %arg.10, ptr noalias %arg.11, ptr noalias %arg.12, ptr noalias %arg.13, ptr noalias %arg.14, ptr noalias %arg.15, ptr noalias %arg.16, ptr noalias %arg.17, ptr noalias %arg.18, ptr noalias %arg.19, ptr noalias %arg.20, ptr noalias %arg.21, ptr noalias %arg.22, ptr noalias %arg.23, ptr noalias %arg.24, ptr noalias %arg.25, ptr noalias %arg.26, ptr %arg.27, ptr %arg.28, ptr noalias %arg.29, ptr noalias %arg.30, ptr noalias %arg.31, ptr noalias %arg.32, ptr noalias %arg.33, ptr noalias %arg.34, ptr noalias %arg.35, ptr noalias %arg.36, ptr noalias %arg.37, ptr noalias %arg.38, ptr noalias %arg.39, ptr noalias %arg.40, ptr noalias %arg.41, ptr noalias %arg.42, ptr noalias %arg.43, ptr noalias %arg.44, ptr noalias %arg.45, ptr noalias %arg.46, ptr noalias %arg.47, ptr noalias %arg.48, ptr noalias %arg.49, ptr noalias %arg.50, ptr noalias %arg.51, ptr noalias %arg.52, ptr noalias %arg.53, ptr noalias %arg.54, ptr noalias %arg.55, ptr %arg.56, ptr %arg.57, ptr %out.0) {
entry:
  ...
  %value.83 = alloca i64, i64 1, align 8
  ...
  store i32 52, ptr %value.187, align 4
  store i32 51, ptr %value.185, align 4
  store i32 50, ptr %value.183, align 4
  store i32 49, ptr %value.181, align 4
  store i32 48, ptr %value.179, align 4
  store i32 47, ptr %value.177, align 4
  store i32 46, ptr %value.175, align 4
  store i32 45, ptr %value.173, align 4
  store i32 44, ptr %value.171, align 4
  store i32 43, ptr %value.169, align 4
  store i32 42, ptr %value.167, align 4
  store i32 41, ptr %value.165, align 4
  store i32 40, ptr %value.163, align 4
  store i32 39, ptr %value.161, align 4
  store i32 38, ptr %value.159, align 4
  store i32 37, ptr %value.157, align 4
  store i32 36, ptr %value.155, align 4
  store i32 35, ptr %value.153, align 4
  store i32 34, ptr %value.151, align 4
  store i32 33, ptr %value.149, align 4
  store i32 32, ptr %value.147, align 4
  store i32 31, ptr %value.145, align 4
  store i32 30, ptr %value.143, align 4
  store i32 29, ptr %value.141, align 4
  store i32 28, ptr %value.139, align 4
  store i32 27, ptr %value.137, align 4
  store i32 26, ptr %value.135, align 4
  store i32 25, ptr %value.133, align 4
  store i32 24, ptr %value.131, align 4
  store i32 23, ptr %value.129, align 4
  store i32 22, ptr %value.127, align 4
  store i32 21, ptr %value.125, align 4
  store i32 20, ptr %value.123, align 4
  store i32 19, ptr %value.121, align 4
  store i32 18, ptr %value.119, align 4
  store i32 17, ptr %value.117, align 4
  store i32 16, ptr %value.115, align 4
  store i32 15, ptr %value.113, align 4
  store i32 14, ptr %value.111, align 4
  store i32 13, ptr %value.109, align 4
  store i32 12, ptr %value.107, align 4
  store i32 11, ptr %value.105, align 4
  store i32 10, ptr %value.103, align 4
  store i32 9, ptr %value.101, align 4
  store i32 8, ptr %value.99, align 4
  store i32 7, ptr %value.97, align 4
  store i32 6, ptr %value.95, align 4
  store i32 5, ptr %value.93, align 4
  store i32 4, ptr %value.91, align 4
  store i32 3, ptr %value.89, align 4
  store i32 2, ptr %value.87, align 4
  store i32 1, ptr %value.85, align 4
  store i64 0, ptr %value.83, align 8
  call void @__ssa_log1p_core_pack__log1p_core__planned_region_0(ptr %arg.19, ptr %arg.27, ptr %arg.18, ptr %arg.17, ptr %arg.16, ptr %arg.15, ptr %arg.14, ptr %arg.13, ptr %arg.11, ptr %arg.10, ptr %arg.9, ptr %arg.8, ptr %arg.7, ptr %arg.6, ptr %arg.5, ptr %arg.4, ptr %arg.3, ptr %arg.2, ptr %arg.26, ptr %arg.25, ptr %arg.24, ptr %arg.23, ptr %arg.22, ptr %arg.21, ptr %arg.20, ptr %arg.12, ptr %arg.1, ptr %arg.0, ptr %arg.28, ptr %arg.48, ptr %arg.56, ptr %arg.47, ptr %arg.46, ptr %arg.45, ptr %arg.44, ptr %arg.43, ptr %arg.42, ptr %arg.40, ptr %arg.39, ptr %arg.38, ptr %arg.37, ptr %arg.36, ptr %arg.35, ptr %arg.34, ptr %arg.33, ptr %arg.32, ptr %arg.31, ptr %arg.55, ptr %arg.54, ptr %arg.53, ptr %arg.52, ptr %arg.51, ptr %arg.50, ptr %arg.49, ptr %arg.41, ptr %arg.30, ptr %arg.29, ptr %arg.57, ptr %out.0, ptr %value.29, ptr %value.30, ptr %value.31, ptr %value.32, ptr %value.33, ptr %value.34, ptr %value.35, ptr %value.36, ptr %value.37, ptr %value.38, ptr %value.39, ptr %value.40, ptr %value.41, ptr %value.42, ptr %value.43, ptr %value.44, ptr %value.45, ptr %value.46, ptr %value.47, ptr %value.48, ptr %value.49, ptr %value.50, ptr %value.51, ptr %value.52, ptr %value.53, ptr %value.54, ptr %value.55, ptr %value.56, ptr %value.57, ptr %value.58, ptr %value.59, ptr %value.60, ptr %value.61, ptr %value.62, ptr %value.63, ptr %value.64, ptr %value.65, ptr %value.66, ptr %value.67, ptr %value.68, ptr %value.69, ptr %value.70, ptr %value.71, ptr %value.72, ptr %value.73, ptr %value.74, ptr %value.75, ptr %value.76, ptr %value.77, ptr %value.78, ptr %value.79, ptr %value.80)
  ret void
}

define void @log1p_core_pack__log1p_core_pack(ptr %buffers, ptr %extents) {
entry:
  ...
  call void @__ssa_log1p_core_pack__log1p_core_pack(ptr %public.0, ptr %public.1, ptr %public.2, ptr %public.3, ptr %public.4, ptr %public.5, ptr %public.6, ptr %public.7, ptr %public.8, ptr %public.9, ptr %public.10, ptr %public.11, ptr %public.12, ptr %public.13, ptr %public.14, ptr %public.15, ptr %public.16, ptr %public.17, ptr %public.18, ptr %public.19, ptr %public.20, ptr %public.21, ptr %public.22, ptr %public.23, ptr %public.24, ptr %public.25, ptr %public.26, ptr %public.27, ptr %public.28, ptr %public.29, ptr %public.30, ptr %public.31, ptr %public.32, ptr %public.33, ptr %public.34, ptr %public.35, ptr %public.36, ptr %public.37, ptr %public.38, ptr %public.39, ptr %public.40, ptr %public.41, ptr %public.42, ptr %public.43, ptr %public.44, ptr %public.45, ptr %public.46, ptr %public.47, ptr %public.48, ptr %public.49, ptr %public.50, ptr %public.51, ptr %public.52, ptr %public.53, ptr %public.54, ptr %public.55, ptr %public.56, ptr %public.2)
  ret void
}
